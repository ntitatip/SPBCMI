...
# 读取 pair 文件
csv_files = ['k=3.csv', 'k=4.csv', 'k=5.csv', 'k=6.csv']
...
class ModelTrainer:
    ...
    def plot_auc_aupr_curves(self):
        ...
        plt.title('Comparison of AUC Curves for Different k-values', linespacing=1.5,
        ...
        plt.title('Comparison of AUPR Curves for Different k-values',
                  linespacing=1.5, fontproperties=title_font, pad=13)
        plt.legend(bbox_to_anchor=(0.05, 0), loc='lower left', prop=legend_font)

...
# 读取 pair 文件
csv_files = ['BERT.csv', 'CNN.csv', 'RNN.csv', 'AE.csv']
...
class ModelTrainer:
    ...
    def plot_auc_aupr_curves(self):
        ...
        plt.title('Comparison of AUC Curves for Multiple Sequence \n Feature Extraction Methods',
                  fontproperties=title_font, linespacing=1.5, pad=7)
        ...
        plt.title('Comparison of AUPR Curves for Multiple Sequence \n Feature Extraction Methods',
                  fontproperties=title_font, linespacing=1.5, pad=7)

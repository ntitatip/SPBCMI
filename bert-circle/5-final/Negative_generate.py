...
class CrossValidationPlot:
    ...
    def plot_auc_curve(self, all_fpr, all_tpr):
        ...
        rgb_values = [(231, 56, 71), (168, 218, 219), (69, 123, 157), (29, 53, 87), (240, 250, 239), (68, 117, 122)]
        ...
        plt.title('Receiver Operating Characteristic (AUC)', fontproperties=title_font, pad=13)
    ...
    def plot_aupr_curve(self, all_recall, all_precision):
        ...
        plt.title('Precision-Recall Curve (AUPR)', fontproperties=title_font, pad=13)
...
feature = read_csv_with_header('Combined Features.csv')
